...
<table id="mainTable" style="width:380px;margin:auto;table-layout:fixed" CELLSPACING=10>
  <tr>
    <img id="cameraImage" src="" style="width:380px;height:250px"></td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    <td></td>
    <td class="button" ontouchstart='sendButtonInput("MoveCar","2")' ontouchend='sendButtonInput("MoveCar","0")'>DOWN</td>
    <td></td>
  </tr>
  <tr/><tr/>
  <tr>
